...
World::World(sf::Vector2i windowSize):mWindowSize(windowSize.x,windowSize.y),mBlockSize(20)
{
   ...
   while(mApple.getPosition()==sf::Vector2f((float)(5*mBlockSize),(float)(7*mBlockSize))
             || mApple.getPosition()==sf::Vector2f((float)(6*mBlockSize),(float)(7*mBlockSize))
             || mApple.getPosition()==sf::Vector2f((float)(7*mBlockSize),(float)(7*mBlockSize))) respawnApple();
}
